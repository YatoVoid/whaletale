...
points in `0..1`. The run prints per-zone entries, passersby, capture rate,
occupied seconds, person-seconds, and dwell p50/p90, plus the achievable
decode+inference FPS.
